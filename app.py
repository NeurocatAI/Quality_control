...
if not st.session_state['access_granted']:
    ...
    if audio_file and st.button("Начать анализ"):
        ...
        # Сохраняем имя файла в Google Таблицу
        ...
        save_to_google_sheets(file_name=file_name, transcription=transcription)
        ...
        save_to_google_sheets(file_name=file_name, dialogue=formatted_dialogue)
        ...
        save_to_google_sheets(file_name=file_name, manager_errors=manager_errors)

        # Рекомендации
        with st.spinner("Формируем рекомендации..."):
            recommendations = generate_recommendations(formatted_dialogue)
        st.subheader("Рекомендации")
        st.write(recommendations)

        save_to_google_sheets(file_name=file_name, improvement_recommendations=recommendations)
        ...
        save_to_google_sheets(file_name=file_name, client_questions=client_questions)
